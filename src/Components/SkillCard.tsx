...
const SkillCard = (props:any) => {
    return <div data-aos="fade-up"   data-aos-duration="800" data-aos-easing="ease-in-sine" className="w-[49%] shadow-[0_0_10px_0_#64FFDA50] rounded-2xl border border-primaryColor p-5">
